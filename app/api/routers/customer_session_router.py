...
@router.post(
    ...
    description="Create a new customer session before ordering food. The backend validates the table and ensures only one active session is allowed per table.",
)
...
@router.put(
    ...
    description="Update customer session details while the session remains ACTIVE. The module does not complete or delete sessions.",
)
